...
// wrap in UMD
(function(factory) {
    if (typeof module === "object" && module.exports) module.exports = factory(); else window.intltelInputregister = factory();
})(function(undefined) {
    "use strict";
    return function() {
            ...
            _createClass(Iti, [ {
                ...
                value: function getNumberType() {
                    if (window.intlTelInputUtils) {
                        ...
                        var result = intlTelInputUtils.getNumberType(this._getFullNumber(), this.selectedCountryData.iso2);
                        return result
...
value: function setCountry(originalCountryCode) {
    ...
    if (this.selectedCountryData.iso2 !== countryCode) {
        ...
        // Update the HTML element with the selected country code
        const selectedCountryCodeElement = document.getElementById('selectedCountryCode');
        if (selectedCountryCodeElement) {
            selectedCountryCodeElement.textContent = this.selectedCountryData.iso2;
        }
