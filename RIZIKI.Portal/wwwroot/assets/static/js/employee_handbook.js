...
var InitiateDataTableDocuments = function () {
    return {
        init: function () {
            var oTable = $('#datatable_employee_handbook_documents').dataTable({
                "bPaginate": true,
...
function GetContractDocuments() {
    $.get('GetRecords', { module: 'employee_handbook' }, function (data) {
        getData(data);
    });
}
...
function getData(jsonstring) {
    table = $('#datatable_employee_handbook_documents').dataTable();
