...
function GetApproveClaims() {
    $.get('GetRecords', { module: 'overtime_claim_approve' }, function (data) {
        getApproveData(data);
    });
}
...
function GetClaims(employee_id) {
    $.get('GetRecords', { module: 'previous_overtime_claim', param: employee_id }, function (data) {
        getData(data);
    });
}
...
$('#SaveApproval').on("click", function (e) {
    ...
    var parameters = {
        id: record_id,
        module: "overtime_claim_approval",
