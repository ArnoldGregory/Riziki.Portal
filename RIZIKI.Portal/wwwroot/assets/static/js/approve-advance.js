        ...
        init: function () {
            ...
            var oTable = $('#editabledatatable').dataTable({
                ...
                "aoColumns": [
                    ...
                    { "data": "formatted_netpay", "autoWidth": true, "sDefaultContent": "n.a" },
            ...
            function viewRow(oTable, nRow) {
                ...
                $('.modal-body #advance_amount').val(json["formatted_amount"]);
...
function GetAdvance() {
    $.get('GetRecords', { module: 'approve_advance_details' }, function (data) {
        getData(data);
    });
}
...
function GetPreviousAdvance(created_by) {
    $.get('GetRecords', {
        module: 'previous_advance_request', param: created_by
    }, function (data) {
...
//    var parameters = {
//        id: id, advancetype: advancetype, amount: amount,
