    ...
    return {
        init: function () {
            ...
            var oTable = $('#editabledatatable').dataTable({
                ...
                "aoColumns": [
                    { "data": "type", "autoWidth": true, "sDefaultContent": "n/a" },
...
function GetAdvanceTypes() {
    $.get('GetRecords', { module: 'client_advance_types' }, function (data) {
        getData(data);
    });
}
...
$('#save').click(function () {
    ...
    $.ajax({
        url: "/ClientManagement/CreateAdvanceType",
        type: "POST",
        data: parameters,
        beforeSend: function () {
