...
function GetNextOfKin() {
    $.get('GetRecords', { module: 'next_of_kin' }, function (data) {
        getData(data);
    });
}
function GetNextOfKinType() {
    $.get('GetRecords', { module: 'next_of_kin_type' }, function (data) {
        $("#type").get(0).options.length = 0;
        $("#type").get(0).options[0] = new Option("Please Select Type Of Next Of Kin", "-1");
