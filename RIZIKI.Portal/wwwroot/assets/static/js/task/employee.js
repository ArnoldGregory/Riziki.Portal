...
const app = {
    ...
    async loadEvents(day) {
        ...
        const { data } = await DayPilot.Http.get(`/api/Schedule?start=${start}&end=${end}&doctor=${doctor}`);
    ...
    async init() {
        const { data } = await DayPilot.Http.get("/api/Supervisor");
...
const calendar = new DayPilot.Calendar("calendar", {
    ...
    onEventMoved: async (args) => {
        ...
        const { data } = await DayPilot.Http.put(`/api/Schedule/${appointment.id}`, appointment);
    },
    ...
    onEventDeleted: async (args) => {
        ...
        await DayPilot.Http.delete(`/api/Schedule/${id}`);
    },
    ...
    onEventClick: async (args) => {
        ...
        await DayPilot.Http.put(`/api/Schedule/${params.id}`, params);
