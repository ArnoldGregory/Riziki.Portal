$(function () {
    ...
    $('#drag-and-drop-zone-ids').dmUploader({ //
        ...
        extFilter: ["doc", "docx", "pdf", "jpg", "jpeg", "png", "gif", "xls", "xlsx", "xlsm"],
        ...
        onUploadSuccess: function (id, data) {
            ...
            for (var i = 0; i < json.length; i++) {
                var item = json[i];
                console.log(item);
                $('#uploadedFiles').append("National_ID,".trim() + item.new_file_name.trim() + "," + item.original_file_name.trim() + "," + id_number + '|<br />');
    ...
    $('#drag-and-drop-zone-passport-photo').dmUploader({ //
        ...
        onUploadSuccess: function (id, data) {
            ...
            for (var i = 0; i < json.length; i++) {
                var item = json[i];
                $('#uploadedFiles').append("Passport_Photo,".trim() + item.new_file_name.trim() + "," + item.original_file_name.trim() + "," + id_number + '|<br />');
    ...
    $('#drag-and-drop-zone-signature').dmUploader({ //
        ...
        onUploadSuccess: function (id, data) {
            ...
            for (var i = 0; i < json.length; i++) {
                var item = json[i];
                $('#uploadedFiles').append("Signature,".trim() + item.new_file_name.trim() + "," + item.original_file_name.trim() + "," + id_number + '|<br />');
                document.getElementById("label_signature").innerHTML = item.original_file_name;
                document.getElementById("label_text_signature").value = item.new_file_name;
                ui_add_log('Server Response for file #' + id + ': ' + item.new_file_name);
                ui_add_log('Upload of file #' + id + ' COMPLETED', 'success');
    ...
    $('#drag-and-drop-zone-kra-pin').dmUploader({ //
        ...
        onUploadSuccess: function (id, data) {
            ...
            for (var i = 0; i < json.length; i++) {
                var item = json[i];
                console.log(item);
                $('#uploadedcorpFiles').append("KRA_PIN,".trim() + item.new_file_name.trim() + "," + item.original_file_name.trim() + '|<br />');
                //document.getElementById("label_national_id").innerHTML = item.original_file_name;
                document.getElementById("label_krapin").innerHTML = item.original_file_name;
                document.getElementById("label_text_krapin").value = item.new_file_name;
                ui_add_log('Server Response for file #' + id + ': ' + item.new_file_name);
                ui_add_log('Upload of file #' + id + ' COMPLETED', 'success');
            ...
            console.log(document.getElementById("uploadedcorpFiles").innerHTML.trim());
        },
        onUploadError: function (id, xhr, status, message) {
    ...
    $('#drag-and-drop-zone-board-resolution').dmUploader({ //
        ...
        onNewFile: function (id, file) {
            // When a new file is added using the file selector or the DnD area
            ui_add_log('New file added #' + id);
            ui_multi_add_file(id, file, 'uploaderFile-boardresolution', 'files');
            //$('#uploadedFiles').append(file.name + '|<br />');
            //document.getElementById("label_boardresolution").innerHTML = file.name;
            //document.getElementById("label_text_boardresolution").value = file.name;
        },
        onBeforeUpload: function (id) {
            // about to start uploading a file
            ui_add_log('Starting the upload of #' + id);
            ui_multi_update_file_status(id, 'uploading', 'Uploading...', 'uploaderFile-boardresolution');
            ui_multi_update_file_progress(id, 0, '', true, 'uploaderFile-boardresolution');
        },
        onUploadCanceled: function (id) {
            // Happens when a file is directly canceled by the user.
            ui_multi_update_file_status(id, 'warning', 'Canceled by User', 'uploaderFile-boardresolution');
            ui_multi_update_file_progress(id, 0, 'warning', false, 'uploaderFile-boardresolution');
        },
        onUploadProgress: function (id, percent) {
            // Updating file progress
            ui_multi_update_file_progress(id, percent, '', true, 'uploaderFile-boardresolution');
        },
        onUploadSuccess: function (id, data) {
            // A file was successfully uploaded
            console.log(data);
            ...
            for (var i = 0; i < json.length; i++) {
                var item = json[i];
                console.log(item);
                $('#uploadedcorpFiles').append("Board_Resolution,".trim() + item.new_file_name.trim() + "," + item.original_file_name.trim() + '|<br />');
                //document.getElementById("label_national_id").innerHTML = item.original_file_name;
                document.getElementById("label_boardresolution").innerHTML = item.original_file_name;
                document.getElementById("label_text_boardresolution").value = item.new_file_name;
                ui_add_log('Server Response for file #' + id + ': ' + item.new_file_name);
                ui_add_log('Upload of file #' + id + ' COMPLETED', 'success');
                ui_multi_update_file_status(id, 'success', 'Upload Complete', 'uploaderFile-boardresolution');
                ui_multi_update_file_progress(id, 100, 'success', false, 'uploaderFile-boardresolution');
            }

            console.log(document.getElementById("uploadedcorpFiles").innerHTML.trim());
        },
        onUploadError: function (id, xhr, status, message) {
            ui_multi_update_file_status(id, 'danger', message, 'uploaderFile-boardresolution');
            ui_multi_update_file_progress(id, 0, 'danger', false, 'uploaderFile-boardresolution');
        },
        onFallbackMode: function () {
            // When the browser doesn't support this plugin :(
            ui_add_log('Plugin cant be used here, running Fallback callback', 'danger');
    ...
    $('#drag-and-drop-zone-cr12').dmUploader({ //
        url: '/ClientSetup/Upload',
        extFilter: ["doc", "docx", "pdf", "jpg", "jpeg", "png", "gif"],
        fieldName: 'postedFiles',
        maxFileSize: 3000000, // 3 Megs 
        ...
        onNewFile: function (id, file) {
            // When a new file is added using the file selector or the DnD area
            ui_add_log('New file added #' + id);
            ui_multi_add_file(id, file, 'uploaderFile-cr12', 'files');
            //$('#uploadedFiles').append(file.name + '|<br />');
            //document.getElementById("label_cr12").innerHTML = file.name;
            //document.getElementById("label_text_cr12").value = file.name;
        },
        onBeforeUpload: function (id) {
            // about to start uploading a file
            ui_add_log('Starting the upload of #' + id);
            ui_multi_update_file_status(id, 'uploading', 'Uploading...', 'uploaderFile-cr12');
            ui_multi_update_file_progress(id, 0, '', true, 'uploaderFile-cr12');
        },
        onUploadCanceled: function (id) {
            // Happens when a file is directly canceled by the user.
            ui_multi_update_file_status(id, 'warning', 'Canceled by User', 'uploaderFile-cr12');
            ui_multi_update_file_progress(id, 0, 'warning', false, 'uploaderFile-cr12');
        },
        onUploadProgress: function (id, percent) {
            // Updating file progress
            ui_multi_update_file_progress(id, percent, '', true, 'uploaderFile-cr12');
        },
        onUploadSuccess: function (id, data) {
            // A file was successfully uploaded
            console.log(data);
            ...
            for (var i = 0; i < json.length; i++) {
                var item = json[i];
                console.log(item);
                $('#uploadedcorpFiles').append("CR12,".trim() + item.new_file_name.trim() + "," + item.original_file_name.trim() + '|<br />');
                //document.getElementById("label_national_id").innerHTML = item.original_file_name;
                document.getElementById("label_cr12").innerHTML = item.original_file_name;
                document.getElementById("label_text_cr12").value = item.new_file_name;
                ui_add_log('Server Response for file #' + id + ': ' + item.new_file_name);
                ui_add_log('Server Response for file #' + id + ': ' + item.new_file_name);
                ui_add_log('Upload of file #' + id + ' COMPLETED', 'success');
                ui_multi_update_file_status(id, 'success', 'Upload Complete', 'uploaderFile-cr12');
                ui_multi_update_file_progress(id, 100, 'success', false, 'uploaderFile-cr12');
            }

            console.log(document.getElementById("uploadedcorpFiles").innerHTML.trim());
        },
        onUploadError: function (id, xhr, status, message) {
            ui_multi_update_file_status(id, 'danger', message, 'uploaderFile-cr12');
            ui_multi_update_file_progress(id, 0, 'danger', false, 'uploaderFile-cr12');
        },
        onFallbackMode: function () {
            // When the browser doesn't support this plugin :(
            ui_add_log('Plugin cant be used here, running Fallback callback', 'danger');
    ...
    $('#drag-and-drop-zone-cr13').dmUploader({ //
        url: '/ClientSetup/Upload',
        extFilter: ["doc", "docx", "pdf", "jpg", "jpeg", "png", "gif"],
        fieldName: 'postedFiles',
        maxFileSize: 3000000, // 3 Megs 
        ...
        onNewFile: function (id, file) {
            // When a new file is added using the file selector or the DnD area
            ui_add_log('New file added #' + id);
            ui_multi_add_file(id, file, 'uploaderFile-cr13', 'files');
            $('#uploadedFiles').append(file.name + '|<br />');
            document.getElementById("label_cr13").innerHTML = file.name;
            document.getElementById("label_text_cr13").value = file.name;
        },
        onBeforeUpload: function (id) {
            // about to start uploading a file
            ui_add_log('Starting the upload of #' + id);
            ui_multi_update_file_status(id, 'uploading', 'Uploading...', 'uploaderFile-cr13');
            ui_multi_update_file_progress(id, 0, '', true, 'uploaderFile-cr13');
        },
        onUploadCanceled: function (id) {
            // Happens when a file is directly canceled by the user.
            ui_multi_update_file_status(id, 'warning', 'Canceled by User', 'uploaderFile-cr13');
            ui_multi_update_file_progress(id, 0, 'warning', false, 'uploaderFile-cr13');
        },
        onUploadProgress: function (id, percent) {
            // Updating file progress
            ui_multi_update_file_progress(id, percent, '', true, 'uploaderFile-cr13');
        },
        onUploadSuccess: function (id, data) {
            // A file was successfully uploaded
            ui_add_log('Server Response for file #' + id + ': ' + data);
            ui_add_log('Upload of file #' + id + ' COMPLETED', 'success');
            ui_multi_update_file_status(id, 'success', 'Upload Complete', 'uploaderFile-cr13');
            ui_multi_update_file_progress(id, 100, 'success', false, 'uploaderFile-cr13');
        },
        onUploadError: function (id, xhr, status, message) {
            ui_multi_update_file_status(id, 'danger', message, 'uploaderFile-cr13');
            ui_multi_update_file_progress(id, 0, 'danger', false, 'uploaderFile-cr13');
        },
        onFallbackMode: function () {
            // When the browser doesn't support this plugin :(
            ui_add_log('Plugin cant be used here, running Fallback callback', 'danger');
        ...
        onFileTypeError: function (file) {
            ...
            RemoveFromUploadedFiles(file.name, "File " + file.name + " cannot be added: invalid file type");
            document.getElementById("label_cr13").innerHTML = '';
            document.getElementById("label_text_cr13").value = '';
        },
        onFileExtError: function (file) {
            ui_add_log('File \'' + file.name + '\' cannot be added: invalid file extension', 'danger');
    ...
    $('#drag-and-drop-zone-moa').dmUploader({ //
        url: '/ClientSetup/Upload',
        extFilter: ["doc", "docx", "pdf", "jpg", "jpeg", "png", "gif"],
        fieldName: 'postedFiles',
        maxFileSize: 3000000, // 3 Megs 
        ...
        onNewFile: function (id, file) {
            // When a new file is added using the file selector or the DnD area
            ui_add_log('New file added #' + id);
            ui_multi_add_file(id, file, 'uploaderFile-moa', 'files');
            //$('#uploadedFiles').append(file.name + '|<br />');
            //document.getElementById("label_moa").innerHTML = file.name;
            //document.getElementById("label_text_moa").value = file.name;
        },
        onBeforeUpload: function (id) {
            // about to start uploading a file
            ui_add_log('Starting the upload of #' + id);
            ui_multi_update_file_status(id, 'uploading', 'Uploading...', 'uploaderFile-moa');
            ui_multi_update_file_progress(id, 0, '', true, 'uploaderFile-moa');
        },
        onUploadCanceled: function (id) {
            // Happens when a file is directly canceled by the user.
            ui_multi_update_file_status(id, 'warning', 'Canceled by User', 'uploaderFile-moa');
            ui_multi_update_file_progress(id, 0, 'warning', false, 'uploaderFile-moa');
        },
        onUploadProgress: function (id, percent) {
            // Updating file progress
            ui_multi_update_file_progress(id, percent, '', true, 'uploaderFile-moa');
        },
        onUploadSuccess: function (id, data) {
            // A file was successfully uploaded
            console.log(data);
            ...
            for (var i = 0; i < json.length; i++) {
                var item = json[i];
                console.log(item);
                $('#uploadedcorpFiles').append("Memorandum_and_articles_of_association,".trim() + item.new_file_name.trim() + "," + item.original_file_name.trim() + '|<br />');
                //document.getElementById("label_national_id").innerHTML = item.original_file_name;
                document.getElementById("label_moa").innerHTML = item.original_file_name;
                document.getElementById("label_text_moa").value = item.new_file_name;
                ui_add_log('Server Response for file #' + id + ': ' + item.new_file_name);
                ui_add_log('Upload of file #' + id + ' COMPLETED', 'success');
                ui_multi_update_file_status(id, 'success', 'Upload Complete', 'uploaderFile-moa');
                ui_multi_update_file_progress(id, 100, 'success', false, 'uploaderFile-moa');
            }

            console.log(document.getElementById("uploadedcorpFiles").innerHTML.trim());
        },
        onUploadError: function (id, xhr, status, message) {
            ui_multi_update_file_status(id, 'danger', message, 'uploaderFile-moa');
            ui_multi_update_file_progress(id, 0, 'danger', false, 'uploaderFile-moa');
        },
        onFallbackMode: function () {
            // When the browser doesn't support this plugin :(
            ui_add_log('Plugin cant be used here, running Fallback callback', 'danger');
    ...
    $('#drag-and-drop-zone-cert-of-inc').dmUploader({ //
        ...
        onNewFile: function (id, file) {
            // When a new file is added using the file selector or the DnD area
            ui_add_log('New file added #' + id);
            ui_multi_add_file(id, file, 'uploaderFile-cert-of-inc', 'files');
            //$('#uploadedFiles').append(file.name + '|<br />');
            //document.getElementById("label_cert_of_inc").innerHTML = file.name;
            //document.getElementById("label_text_cert_of_inc").value = file.name;
        },
        onBeforeUpload: function (id) {
            // about to start uploading a file
            ui_add_log('Starting the upload of #' + id);
        ...
        onUploadSuccess: function (id, data) {
            ...
            for (var i = 0; i < json.length; i++) {
                var item = json[i];
                console.log(item);
                $('#uploadedcorpFiles').append("incorporation_cert,".trim() + item.new_file_name.trim() + "," + item.original_file_name.trim() + '|<br />');

                document.getElementById("label_cert_of_inc").innerHTML = item.original_file_name;
                document.getElementById("label_text_cert_of_inc").value = item.new_file_name;
                ui_add_log('Server Response for file #' + id + ': ' + item.new_file_name);
                ui_add_log('Upload of file #' + id + ' COMPLETED', 'success');
